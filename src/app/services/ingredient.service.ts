...
export class IngredientService {
    ...
    getCategories () :  Observable<String[]>{
        return this.http.get<String[]>("http://localhost:3000/api/ingredients/categories")
    }
    
    getIngredientsByCategory (category) : Observable<any[]>{
        return this.http.get<any[]>("http://localhost:3000/api/ingredients/category?category="+category)
    }
    ...
    addIngredientSynonyme (ingredient,synonyme) : void{
        ...
        this.http.put("http://localhost:3000/api/ingredients/update",
